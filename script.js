...
var speedConvert = function() {
	...
	var addNote = '<div class="NoteClass" id="NoteNo' + noteCounter + '"><input type="checkbox" class="CheckClass" id="CheckNo' + noteCounter + '">  ' + textResult + '</input><br></div>';
	document.getElementById("Notes").innerHTML += addNote;
	noteCounter++;
	}
};
